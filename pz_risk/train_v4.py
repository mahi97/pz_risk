...
class Coach:
    ...
    def initialize(self):
        ...
        self.critic = DVNAgent(self.n_nodes, self.n_agents, self.type_size, self.feat_size, self.hidden_size,
                               self.device)
        self.last_critic = DVNAgent(self.n_nodes, self.n_agents, self.type_size, self.feat_size, self.hidden_size,
                                    self.device)
        if self.episode == 0:
