...
class Coach:
    ...
    def initialize(self):
        ...
        self.env = env(n_agent=self.n_agents,
                       board_name='d_{}_{}_random'.format(self.n_nodes, int(self.n_nodes * self.args.unit_coef)),
                       edge_p=self.args.edge_p)
